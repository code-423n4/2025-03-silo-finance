...
contract VotingEscrowChildChainTest is IntegrationTest {
    ...
    IVeSilo.Point public tsTestPoint =
        IVeSilo.Point({bias: 2947469178042106200, slope: 95129375950, ts: 1695115404, blk: 4319390});

    IVeSilo.Point public uTestPoint =
        IVeSilo.Point({bias: 982489726003707468, slope: 31709791983, ts: 1695115404, blk: 4319390});
    ...
    function testReceiveBalanceAndTotalSupply() public {
        ...
        emit UserBalanceUpdated(_localUser, _LOCKED_END_TEST, uTestPoint);
    ...
    function getCCIPMessage(bytes memory _data) public view returns (Client.Any2EVMMessage memory ccipMessage) {
