...
contract L2Test is IntegrationTest {
    ...
    function _mockSiloCoreCalls() internal {
        vm.mockCall(_shareToken, abi.encodeWithSelector(IShareToken.balanceOf.selector, _bob), abi.encode(500_000e18));

        vm.mockCall(_shareToken, abi.encodeWithSelector(IShareToken.totalSupply.selector), abi.encode(200_000_000e18));
