...
contract VETSIP01 is Proposal {
    string public constant GAUGE_KEY = "Test gauge";
    string public constant GAUGE_TYPE = "Mainnet gauge";
    string public constant PROPOSAL_DESCRIPTION = "Gauge configuration";
    ...
    function run() public override returns (uint256 proposalId) {
        ...
        address gaugeAdderAddr = VeSiloDeployments.get(VeSiloContracts.GAUGE_ADDER, ChainsLib.chainAlias());
