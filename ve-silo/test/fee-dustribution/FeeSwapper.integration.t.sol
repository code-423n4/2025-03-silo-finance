...
contract FeeSwapperTest is IntegrationTest {
    uint256 internal constant _FORKING_BLOCK_NUMBER = 18040200;
    address internal constant _SNX_WHALE = 0x5Fd79D46EBA7F351fe49BFF9E87cdeA6c821eF9f;
    ...
    function _addSwapper(address _signer, IERC20 _asset, IFeeSwap _swap) internal {
        ...
        configs[0] = IFeeSwapper.SwapperConfigInput({asset: _asset, swap: _swap});
