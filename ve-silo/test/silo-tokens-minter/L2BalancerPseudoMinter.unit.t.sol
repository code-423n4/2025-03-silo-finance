...
import {L2BalancerPseudoMinterDeploy, IL2BalancerPseudoMinter} from "ve-silo/deploy/L2BalancerPseudoMinterDeploy.s.sol";
...
contract L2BalancerPseudoMinterTest is IntegrationTest {
    ...
    function _mockCallsForTest() internal {
        vm.mockCall(_gauge, abi.encodeWithSelector(ISiloChildChainGauge.silo.selector), abi.encode(_silo));
