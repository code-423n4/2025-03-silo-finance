...
import {StakelessGaugeCheckpointerAdaptorDeploy, IStakelessGaugeCheckpointerAdaptor, StakelessGaugeCheckpointerAdaptor} from "ve-silo/deploy/StakelessGaugeCheckpointerAdaptorDeploy.s.sol";
...
contract StakelessGaugeCheckpointerAdaptorTest is IntegrationTest {
    ...
    function _mockCalls() internal {
        vm.mockCall(_gauge, abi.encodeWithSelector(IStakelessGauge.checkpoint.selector), abi.encode(true));
    }
}
