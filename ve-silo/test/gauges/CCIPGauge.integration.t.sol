...
contract CCIPGaugeTest is IntegrationTest {
    ...
    function testTransferWithFeesInLINK() public {
        ...
        vm.mockCall(_minter, abi.encodeWithSelector(IBalancerMinter.minted.selector, gauge, gauge), abi.encode(0));
    ...
    function _mockCallsAfterGaugeCreated() internal {
        ...
        vm.mockCall(_minter, abi.encodeWithSelector(IBalancerMinter.mint.selector, address(_gauge)), abi.encode(true));
    }
