...
contract GaugeControllerTest is IntegrationTest {
    ...
    int128 internal constant _GAUGE_TYPE = 0;
    uint256 internal constant _GAUGE_WEIGHT = 0;
    ...
    function testEnsureDeployedWithCorrectData() public {
        ...
        assertEq(_controller.voting_escrow(), getAddress(VeSiloContracts.VOTING_ESCROW), "Invalid voting escrow token");

        assertEq(_controller.admin(), _timelock, "TimelockController should be an admin");
    }
