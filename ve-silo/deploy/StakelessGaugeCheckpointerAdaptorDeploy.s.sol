...
import {StakelessGaugeCheckpointerAdaptor} from "ve-silo/contracts/gauges/stakeless-gauge/StakelessGaugeCheckpointerAdaptor.sol";
...
contract StakelessGaugeCheckpointerAdaptorDeploy is CommonDeploy {
    function run() public returns (IStakelessGaugeCheckpointerAdaptor adaptor) {
        ...
        adaptor = IStakelessGaugeCheckpointerAdaptor(
            address(new StakelessGaugeCheckpointerAdaptor(getAddress(AddrKey.LINK)))
        );
