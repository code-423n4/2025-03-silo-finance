...
contract LiquidityGaugeDeployer is GaugeDeployScript {
    ...
    function run() public returns (address gauge) {
        ...
        LiquidityGaugeDeploymentConfig memory config = LiquidityGaugeConfigsParser.getConfig(chainAlias, cofigName);
        ...
        ILiquidityGaugeFactory factory = ILiquidityGaugeFactory(
            VeSiloDeployments.get(VeSiloContracts.LIQUIDITY_GAUGE_FACTORY, chainAlias)
        );
