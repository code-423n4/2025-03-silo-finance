...
library LiquidityGaugeConfigsParser {
    string public constant CONFIGS_DIR = "ve-silo/deploy/gauges/liquidity-gauge/configs/";
    string internal constant _EXTENSION = ".json";

    function getConfig(
        string memory _network,
        string memory _name
    ) internal returns (LiquidityGaugeDeployer.LiquidityGaugeDeploymentConfig memory config) {
