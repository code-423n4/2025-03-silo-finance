...
abstract contract GaugeDeployScript is Script {
    bytes32 internal constant _TYPE_SHARE_P_TOKEN = keccak256(abi.encodePacked("protectedShareToken"));
    bytes32 internal constant _TYPE_SHARE_D_TOKEN = keccak256(abi.encodePacked("debtShareToken"));
    bytes32 internal constant _TYPE_SHARE_C_TOKEN = keccak256(abi.encodePacked("collateralShareToken"));
