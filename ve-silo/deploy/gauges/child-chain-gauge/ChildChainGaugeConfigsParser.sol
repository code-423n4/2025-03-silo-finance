...
library ChildChainGaugeConfigsParser {
    string public constant CONFIGS_DIR = "ve-silo/deploy/gauges/child-chain-gauge/configs/";
    string internal constant _EXTENSION = ".json";

    function getConfig(
        string memory _network,
        string memory _name
    ) internal returns (ChildChainGaugeDeployer.ChildChainGaugeDeploymentConfig memory config) {
