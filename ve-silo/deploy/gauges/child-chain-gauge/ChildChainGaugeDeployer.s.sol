...
contract ChildChainGaugeDeployer is GaugeDeployScript {
    ...
    function run() public returns (address gauge) {
        ...
        ChildChainGaugeDeploymentConfig memory config = ChildChainGaugeConfigsParser.getConfig(chainAlias, cofigName);
        ...
        IChildChainGaugeFactory factory = IChildChainGaugeFactory(
            VeSiloDeployments.get(VeSiloContracts.CHILD_CHAIN_GAUGE_FACTORY, chainAlias)
        );
