...
contract CCIPGaugeArbitrumDeploy is CommonDeploy {
    bytes32 internal constant _CHAIN_ALIAS = keccak256(abi.encodePacked("arbitrum_one"));
    ...
    function run() public returns (ICCIPGauge gaugeImplementation) {
        ...
        gaugeImplementation = ICCIPGauge(address(new CCIPGaugeArbitrum(IMainnetBalancerMinter(mainnetBalancerMinter))));
