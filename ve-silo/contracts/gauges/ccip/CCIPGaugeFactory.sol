...
abstract contract CCIPGaugeFactory is BaseGaugeFactory, Ownable2Step {
    ...
    constructor(address _beacon, address _checkpointer) Ownable(msg.sender) BaseGaugeFactory(address(0)) {
     ...
     */
    function getGaugeImplementation() public view override returns (address) {
