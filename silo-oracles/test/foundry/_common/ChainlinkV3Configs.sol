...
abstract contract ChainlinkV3Configs is TokensGenerator {
    function _spellEthChainlinkV3Config(
        uint256 _divider,
        uint256 _multiplier
    ) internal view returns (IChainlinkV3Oracle.ChainlinkV3DeploymentConfig memory) {
        return
            IChainlinkV3Oracle.ChainlinkV3DeploymentConfig(
    ...
    function _spellUsdChainlinkV3Config(
        uint256 _divider,
        uint256 _multiplier
    ) internal view returns (IChainlinkV3Oracle.ChainlinkV3DeploymentConfig memory) {
        return
    ...
    function _dydxChainlinkV3Config(
        uint256 _divider,
        uint256 _multiplier
    ) internal view returns (IChainlinkV3Oracle.ChainlinkV3DeploymentConfig memory) {
        return
