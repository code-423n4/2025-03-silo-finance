...
contract PendlePTOracleDeploy is CommonDeploy {
    ...
    function run() public returns (ISiloOracle oracle) {
        PendlePTOracleFactory factory = PendlePTOracleFactory(
            getDeployedAddress(SiloOraclesFactoriesContracts.PENDLE_PT_ORACLE_FACTORY)
        );
        ...
        oracle = factory.create({_underlyingOracle: underlyingOracle, _market: market});
