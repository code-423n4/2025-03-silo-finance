...
contract UniswapV3OracleFactory is OracleFactory {
    ...
    ) external view virtual returns (bool bufferFull, bool enoughObservations, uint16 currentCardinality) {
    ...
    function verifyPool(IUniswapV3Pool _pool, address _quoteToken, uint16 _requiredCardinality) external view virtual {
    ...
    function hashConfig(
        IUniswapV3Oracle.UniswapV3DeploymentConfig memory _config
    ) public view virtual returns (bytes32 configId) {
    ...
    function verifyConfig(
        IUniswapV3Oracle.UniswapV3DeploymentConfig memory _config
    ) public pure virtual returns (uint16 requiredCardinality) {
    ...
    function _observationsStatus(
        IUniswapV3Pool _pool,
        uint16 _requiredCardinality
    ) internal view virtual returns (bool bufferFull, bool enoughObservations, uint16 currentCardinality) {
