...
contract DIAOracleFactory is OracleFactory {
    ...
    function create(IDIAOracle.DIADeploymentConfig calldata _config) external virtual returns (DIAOracle oracle) {
    ...
    function hashConfig(IDIAOracle.DIADeploymentConfig memory _config) public view virtual returns (bytes32 configId) {
