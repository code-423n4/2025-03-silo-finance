...
contract VaultIncentivesModule is IVaultIncentivesModule, Ownable2StepUpgradeable {
    ...
    function submitIncentivesClaimingLogic(
        ...
        unchecked {
            pendingClaimingLogics[_market][_logic] = block.timestamp + timelock;
        }
    ...
    /// @inheritdoc IVaultIncentivesModule
    function acceptIncentivesClaimingLogic(IERC4626 _market, IIncentivesClaimingLogic _logic) external virtual {
    ...
    /// @inheritdoc IVaultIncentivesModule
    function revokePendingClaimingLogic(
        IERC4626 _market,
        IIncentivesClaimingLogic _logic
    ...
    /// @inheritdoc IVaultIncentivesModule
    function getMarketsIncentivesClaimingLogics(
        address[] calldata _marketsInput
    ) external view virtual returns (address[] memory logics) {
    ...
    /// @inheritdoc IVaultIncentivesModule
    function getMarketIncentivesClaimingLogics(
        IERC4626 market
    ) external view virtual returns (address[] memory logics) {
