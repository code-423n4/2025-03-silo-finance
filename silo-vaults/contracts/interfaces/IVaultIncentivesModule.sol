...
interface IVaultIncentivesModule {
    ...
    function removeNotificationReceiver(INotificationReceiver _notificationReceiver, bool _allProgramsStopped) external;
    ...
    ) external view returns (address[] memory logics);
