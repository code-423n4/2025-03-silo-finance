...
contract ReentrancyTestState {
    ...
    function set(address _vault, address _owner, address _market, address _asset) external {
        vault = _vault;
        owner = _owner;
        market = _market;
        asset = _asset;
...
library TestStateLib {
    ...
    function init(address _vault, address _owner, address _market, address _asset) internal {
