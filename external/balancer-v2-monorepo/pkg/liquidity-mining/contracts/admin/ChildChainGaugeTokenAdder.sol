...
contract ChildChainGaugeTokenAdder is SingletonAuthentication {
    ...
    constructor(
        IChildChainLiquidityGaugeFactory gaugeFactory,
     ...
     */
    function addTokenToGauge(IRewardsOnlyGauge gauge, IERC20 rewardToken, address distributor) external authenticate {
    ...
    function _addTokenToStreamer(IChildChainStreamer streamer, IERC20 rewardToken, address distributor) private {
