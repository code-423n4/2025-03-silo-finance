...
contract BALTokenHolder is IBALTokenHolder, SingletonAuthentication {
    ...
    constructor(IBalancerToken balancerToken, IVault vault, string memory name) SingletonAuthentication(vault) {
    ...
    function sweepTokens(IERC20 token, address recipient, uint256 amount) external override authenticate {
