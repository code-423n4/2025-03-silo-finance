...
contract MockStaticATokenLM is ERC20Mock, IStaticATokenLM {
    ...
    function withdrawDynamicAmount(address, uint256, bool) external pure override returns (uint256, uint256) {
        _revert(Errors.UNIMPLEMENTED);
    }
    ...
    function claimRewardsOnBehalf(address, address, bool) external pure override {
        _revert(Errors.UNIMPLEMENTED);
    }
