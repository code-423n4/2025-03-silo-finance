...
interface IMockEulerProtocol {
     ...
     */
    function requestUnderlyingFromRelayer(address underlying, uint256 amount, address msgSender) external;

    /**
     * @notice Sends tokens from EulerProtocol to relayer
     * @dev This is a simple ERC20.transfer
     */
    function sendUnderlyingToRelayer(address wrappedToken, uint256 amount, address relayer) external;
}
