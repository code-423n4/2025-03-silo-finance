...
abstract contract LidoWrapping is IBaseRelayerLibrary {
    ...
    function wrapStETH(address sender, address recipient, uint256 amount, uint256 outputReference) external payable {
    ...
    function unwrapWstETH(address sender, address recipient, uint256 amount, uint256 outputReference) external payable {
    ...
    function stakeETH(address recipient, uint256 amount, uint256 outputReference) external payable {
    ...
    function stakeETHAndWrap(address recipient, uint256 amount, uint256 outputReference) external payable {
        amount = _resolveAmount(amount);
