...
contract MathLibCaller {
    ...
    {
        (collateralAssetsWithInterest, debtAssetsWithInterest, daoAndDeployerRevenue, accruedInterest) = SiloMathLib
            .getCollateralAmountsWithInterest(_collateralAssets, _debtAssets, _rcomp, _daoFee, _deployerFee);
    }
