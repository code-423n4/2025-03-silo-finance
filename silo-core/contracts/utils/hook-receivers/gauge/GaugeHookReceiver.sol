...
abstract contract GaugeHookReceiver is BaseHookReceiver, IGaugeHookReceiver, Ownable2Step {
    ...
    function afterAction(address _silo, uint256 _action, bytes calldata _inputAndOutput) public virtual override {
    ...
    function __GaugeHookReceiver_init(address _owner) internal virtual onlyInitializing {
