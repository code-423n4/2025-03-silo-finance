...
abstract contract ShareToken is ERC20PermitUpgradeable, IShareToken {
    ...
    function forwardTransferFromNoChecks(
        ...
        address _to,
        uint256 _amount
    ) external virtual onlyHookReceiver {
        IShareToken.ShareTokenStorage storage $ = ShareTokenLib.getShareTokenStorage();
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _amount
    ) public virtual override(ERC20Upgradeable, IERC20) returns (bool result) {
    ...
    function _shareTokenInitialize(ISilo _silo, address _hookReceiver, uint24 _tokenType) internal virtual initializer {
