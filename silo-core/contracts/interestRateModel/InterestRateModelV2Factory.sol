...
contract InterestRateModelV2Factory is IInterestRateModelV2Factory {
    ...
    function create(
        IInterestRateModelV2.Config calldata _config
    ) external virtual returns (bytes32 configHash, IInterestRateModelV2 irm) {
    ...
    /// @inheritdoc IInterestRateModelV2Factory
    function hashConfig(IInterestRateModelV2.Config calldata _config) public pure virtual returns (bytes32 configId) {
