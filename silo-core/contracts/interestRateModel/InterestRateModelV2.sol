...
contract InterestRateModelV2 is IInterestRateModel, IInterestRateModelV2 {
    ...
    function _calculateRComp(
        ...
        unchecked {
            ...
            if (
                rcompMulTBA / rcomp != _totalBorrowAmount || rcompMulTBA / _DP > ASSET_DATA_OVERFLOW_LIMIT - maxAmount
            ) {
    ...
    function _compoundInterestRateCAP(
        uint256 _rcomp,
        uint256 _t
    ) internal pure virtual returns (uint256 updatedRcomp, bool capApplied) {
