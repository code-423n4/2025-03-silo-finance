...
contract LiquidationCall2TokensTest is SiloLittleHelper, Test {
    ...
    */
    function test_liquidationCall_partial_2tokens() public {
        ...
        (uint256 collateralToLiquidate, uint256 debtToRepay, bool sTokenRequired) = partialLiquidation.maxLiquidation(
            BORROWER
        );
    ...
    */
    ...
    function _timeForwardAndDebug(uint256 _time) internal {
        ...
        int256 calculatedLiquidity = (COLLATERAL_FOR_BORROW - DEBT).toInt256() -
