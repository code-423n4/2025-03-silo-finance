...
contract GetExactLiquidationAmountsTest is GetExactLiquidationAmountsHelper {
    ...
    */
    function test_getExactLiquidationAmounts_noOracle_loop() public {
        ...
        GetExactLiquidationAmountsTestData.GELAData[] memory testDatas = new GetExactLiquidationAmountsTestData()
            .getData();
    ...
    */
    ...
    function test_getExactLiquidationAmounts_liquidation_fuzz(
        ...
        (uint256 collateralToLiquidate, , bool success, bytes4 errorType) = _tryGetExactLiquidationAmounts(
            _maxDebtToCover,
    ...
    function _tryGetExactLiquidationAmounts(
        ...
        try
            GetExactLiquidationAmountsHelper(this).getExactLiquidationAmounts(
                _maxDebtToCover,
                _collateralUserBalanceOf,
                _debtUserBalanceOf,
                _liquidationFee
