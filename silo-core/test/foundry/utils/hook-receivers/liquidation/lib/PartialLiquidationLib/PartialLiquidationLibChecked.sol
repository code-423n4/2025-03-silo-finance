...
library PartialLiquidationLibChecked {
    ...
    function maxLiquidation(
        ...
        (uint256 collateralValueToLiquidate, uint256 repayValue) = maxLiquidationPreview(
    ...
    function estimateMaxRepayValue(
        ...
        return
            (repayValue * _PRECISION_DECIMALS) / _totalBorrowerDebtValue > _FULL_LIQUIDATION_THRESHOLD
                ? _totalBorrowerDebtValue
                : repayValue;
    }
