...
abstract contract SiloLittleHelper is CommonBase {
    ...
    function _depositForBorrowRevert(
        uint256 _assets,
        address _depositor,
    ...
    function _depositCollateral(uint256 _assets, address _depositor, bool _toSilo1) internal returns (uint256 shares) {
        return
            _toSilo1
    ...
    function _localFixture(
        string memory _configName,
        SiloFixture _siloFixture
    ) private returns (ISiloConfig siloConfig) {
