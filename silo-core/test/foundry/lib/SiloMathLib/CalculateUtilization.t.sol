...
contract CalculateUtilizationTest is Test {
    ...
    */
    function test_calculateUtilizationWithMax_fuzz(
        uint256 _dp,
    ...
    */
    function test_utilizationEqualDP_fuzz(uint256 _dp, uint256 _collateralAssets, uint256 _debtAssets) public pure {
