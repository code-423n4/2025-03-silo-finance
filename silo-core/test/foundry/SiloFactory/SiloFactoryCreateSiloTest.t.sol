...
contract SiloFactoryCreateSiloTest is SiloLittleHelper, IntegrationTest {
    ...
    */
    function test_createSilo() public {
        ...
        IInterestRateModelV2.Config memory irmConfigExpected0 = modelData.getConfigData(
            siloConfigData.interestRateModelConfig0
        );
        ...
        IInterestRateModelV2.Config memory irmConfigExpected1 = modelData.getConfigData(
            siloConfigData.interestRateModelConfig1
        );
