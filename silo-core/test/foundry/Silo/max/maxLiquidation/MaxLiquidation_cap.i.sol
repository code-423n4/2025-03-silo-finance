...
contract MaxLiquidationCapTest is MaxLiquidationCommon {
    ...
    */
    function test_maxLiquidation_cap_1token() public {
        ...
        (uint256 collateralToLiquidate2, uint256 maxDebtToCover2, bool sTokenRequired2) = partialLiquidation
            .maxLiquidation(borrower);
    ...
    */
    function test_maxLiquidation_cap_2tokens() public {
        ...
        (uint256 collateralToLiquidate, uint256 maxDebtToCover, bool sTokenRequired) = partialLiquidation
            .maxLiquidation(borrower);
