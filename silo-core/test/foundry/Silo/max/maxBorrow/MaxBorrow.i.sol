...
contract MaxBorrowTest is SiloLittleHelper, Test {
    ...
    */
    ...
    function test_maxBorrow_repayWithInterest_1token_protected_fuzz(uint64 _collateral, uint128 _liquidity) public {
    ...
    function _assertWeCanNotBorrowAboveMax(uint256 _maxBorrow, uint256 _precision, bool _sameAsset) internal {
        ...
        if (_maxBorrow > 0) {
            emit log_named_decimal_uint(
                "[_assertWeCanNotBorrowAboveMax] _maxBorrow > 0? YES, borrowing max",
                _maxBorrow,
                18
            );
            ...
            emit log_named_decimal_uint(
                "[_assertWeCanNotBorrowAboveMax]                          liquidity",
                liquidity,
                18
            );
