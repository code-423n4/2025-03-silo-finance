...
contract GetLiquidityAccrueInterestTest is SiloLittleHelper, Test {
    ...
    */
    function test_liquidity_whenDeposit(uint128 _assets) public {
        ...
        assertEq(
            ...
            0,
            "[1] no protected liquidity after deploy 1"
        );
    }
    ...
    */
    ...
    function _liquidity_whenDepositAndBorrowWithInterest(uint128 _toDeposit, uint128 _toBorrow) private {
        ...
        assertEq(silo1_liquidityWithInterest, silo1.getLiquidity(), "[1] expect getLiquidity() calculations correct");
    ...
    function _getRawLiquidity(ISilo _silo) internal view returns (uint256) {
        return
            _silo.getTotalAssetsStorage(ISilo.AssetType.Collateral) - _silo.getTotalAssetsStorage(ISilo.AssetType.Debt);
    }
}
