...
import {UniswapV3OracleFactoryMock} from "silo-core/test/foundry/_mocks/oracles-factories/UniswapV3OracleFactoryMock.sol";

import {ChainlinkV3OracleFactoryMock} from "silo-core/test/foundry/_mocks/oracles-factories/ChainlinkV3OracleFactoryMock.sol";
...
contract SiloDeployTest is IntegrationTest {
    ...
    function _mockOraclesFactories() internal {
        AddrLib.setAddress(SiloOraclesFactoriesContracts.UNISWAP_V3_ORACLE_FACTORY, address(_uniV3OracleFactoryMock));
    }
}
