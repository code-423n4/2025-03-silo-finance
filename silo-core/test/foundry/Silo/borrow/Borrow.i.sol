...
contract BorrowIntegrationTest is SiloLittleHelper, Test {
    ...
    */
    ...
    function _borrow_pass() private {
        ...
        assertEq(
            IShareToken(debtShareToken).balanceOf(borrower),
            maxBorrow,
            "expect borrower to have debt in debt silo"
        );
    ...
    */
    ...
    function _borrowTwoAssetsAssertions(address _borrower, address _debtShareToken, address _collateralToken) private {
