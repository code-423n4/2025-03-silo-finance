...
contract SiloIncentivesControllerTest is Test {
    ...
    function test_createIncentivesProgram_Success() public {
        ...
        IDistributionManager.IncentiveProgramDetails memory detailsBefore = _controller.incentivesProgram(
            _PROGRAM_NAME
        );
        ...
        uint256 expectedIndex = (emissionPerSecond * (block.timestamp - lastUpdateTimestamp) * _PRECISION) /
            _TOTAL_SUPPLY;
