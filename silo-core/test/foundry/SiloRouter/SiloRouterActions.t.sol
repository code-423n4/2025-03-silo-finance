...
contract SiloRouterActionsTest is IntegrationTest {
    ...
    function test_siloRouter_unwrapAndTransfer_nativeToken() public {
        ...
        data[0] = abi.encodeCall(
            SiloRouterImplementation.transferFrom,
            (IWrappedNativeToken(nativeToken), address(router), _S_BALANCE)
        );
    ...
    function test_siloRouter_approve() public {
        ...
        data[0] = abi.encodeCall(
            SiloRouterImplementation.approve,
            (IERC20(nativeToken), address(this), type(uint256).max)
        );
    ...
    function test_siloRouter_transferFrom() public {
        ...
        data[0] = abi.encodeCall(
            SiloRouterImplementation.transferFrom,
            (IERC20(nativeToken), address(this), _S_BALANCE)
        );
    ...
    function test_siloRouter_depositFlow() public {
        ...
        data[2] = abi.encodeCall(
            SiloRouterImplementation.deposit,
            (ISilo(silo0), _S_BALANCE, ISilo.CollateralType.Collateral)
        );
    ...
    function test_siloRouter_withdrawFlow() public {
        ...
        bytes[] memory data = new bytes[](1);
        data[0] = abi.encodeCall(
            SiloRouterImplementation.withdraw,
    ...
    function test_siloRouter_withdrawAllFlow() public {
        ...
        bytes[] memory data = new bytes[](1);
        data[0] = abi.encodeCall(
            SiloRouterImplementation.withdrawAll,
            (ISilo(silo0), depositor, ISilo.CollateralType.Collateral)
        );
    ...
    function test_siloRouter_withdrawAllAndUnwrapFlow() public {
        ...
        data[0] = abi.encodeCall(
            SiloRouterImplementation.withdrawAll,
            (ISilo(silo0), address(router), ISilo.CollateralType.Collateral)
        );
    ...
    function test_siloRouter_borrowSameAssetFlow() public {
        ...
        bytes[] memory data = new bytes[](1);
        data[0] = abi.encodeCall(
            SiloRouterImplementation.borrowSameAsset,
            (ISilo(silo0), borrowAmount, address(borrower))
        );
    ...
    function test_siloRouter_repayAllNativeFlow() public {
        ...
        data[0] = abi.encodeCall(
            ...
            (IWrappedNativeToken(nativeToken), ISilo(silo0))
        );
