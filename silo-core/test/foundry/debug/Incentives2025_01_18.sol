...
import {SiloIncentivesControllerGaugeLikeFactoryDeploy} from "silo-core/deploy/SiloIncentivesControllerGaugeLikeFactoryDeploy.sol";
...
contract Incentives20250118Test is IntegrationTest {
    SiloIncentivesController internal _controller =
        SiloIncentivesController(0x31bFB77eF861d9273658d5e943a7BF2E2c8B0b7f);
    ...
    */
    ...
    function test_one_more_scenario() public {
        ...
        _controller = SiloIncentivesController(address(factory.createGaugeLike(owner, notifier, shareToken)));
    ...
    function _getRewards(
        ...
        unchecked {
            rewards /= _controller.TEN_POW_PRECISION();
        }
    }
