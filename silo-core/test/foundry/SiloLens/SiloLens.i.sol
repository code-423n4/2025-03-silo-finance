...
contract SiloLensIntegrationTest is SiloLittleHelper, Test {
    ...
    */
    function test_siloLens_utilization_75() public {
        ...
        assertEq(siloLens.calculateBorrowValue(siloConfig, borrower), toBorrow, "calculateBorrowValue (price is 1:1)");
        ...
        assertEq(siloLens.collateralBalanceOfUnderlying(silo0, borrower), collateral, "collateralBalanceOfUnderlying");
