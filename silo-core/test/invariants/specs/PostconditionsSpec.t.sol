...
abstract contract PostconditionsSpec {
    ...
    string constant SILO_HSPOST_B =
        "SILO_HSPOST_B: impossible to mint 0 shares or burn 0 shares or transfer 0 assets inside any function in Silo"; // TODO
    ...
    string constant LENDING_HSPOST_A =
        "LENDING_HSPOST_A: after deposit, silo.totalAssets[ISilo.AssetType.Collateral] increases by amount deposited"; // TODO
    ...
    string constant SILO_INVARIANT_I =
        "SILO_INVARIANT_I: _debtShareToken totalSupply MUST be the sum of all borrowed shares"; //custom

    string constant SILO_INVARIANT_J = "SILO_INVARIANT_J: _collateralShareToken balance MUST increase while depositing"; //custom

    string constant SILO_INVARIANT_K =
        "SILO_INVARIANT_K: _collateralShareToken balance MUST decrease while withdrawing"; //custom
}
