...
abstract contract InvariantsSpec {
    ...
    string constant BASE_INVARIANT_D =
        "BASE_INVARIANT_D: user is solvent and shareDebtToken.balanceOf(user) != zero => protectedShareToken.balanceOf(user) + collateralShareToken.balanceOf(user) == 0"; // TODO
    ...
    string constant BORROWING_INVARIANT_D =
        "BORROWING_INVARIANT_D: If user has debt in one silo, his share token balance on the other silo should be != 0";
