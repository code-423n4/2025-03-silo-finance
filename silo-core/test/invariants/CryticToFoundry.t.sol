...
contract CryticToFoundry is Invariants, Setup {
    ...
    function test_echidna_BASE_INVARIANT2() public {
        ...
        this.increaseReceiveAllowance(
            99660895124953974644233210972242386669999403047765480327126411789742549576368,
            181,
            91
        );
        _delay(141692);
    ...
    function test_liquidationCallEchidna() public {
        ...
        Tester.liquidationCall(
            1179245955276247436741786656479833618730492640882500598892,
            false,
            RandomGenerator(0, 0, 1)
        );
    }
    ...
    function test_replayassert_LENDING_INVARIANT_B() public {
        ...
        Tester.decreaseReceiveAllowance(
            83707498239647981397465107311606052962400530930157546111810393385972674224550,
            62,
            27
        );
        _delay(10674);
