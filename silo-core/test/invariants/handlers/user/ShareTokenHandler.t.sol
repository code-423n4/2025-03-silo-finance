    ...
    */
    ...
    function transferFrom(uint256 _amount, uint8 i, uint8 j, uint8 k) external setup {
        ...
        (success, returnData) = actor.proxy(
            target,
            abi.encodeWithSelector(IERC20.transferFrom.selector, from, to, _amount)
        );
    ...
    function setReceiveApproval(uint256 _amount, uint8 i, uint8 j) external setup {
        bool success;
        bytes memory returnData;
        ...
        (success, returnData) = actor.proxy(
            target,
            abi.encodeWithSelector(ShareDebtToken.setReceiveApproval.selector, owner, _amount)
        );
    ...
    function decreaseReceiveAllowance(uint256 _subtractedValue, uint8 i, uint8 j) external setup {
        bool success;
        bytes memory returnData;
    ...
    function increaseReceiveAllowance(uint256 _addedValue, uint8 i, uint8 j) external setup {
        bool success;
        bytes memory returnData;
        ...
        (success, returnData) = actor.proxy(
            target,
            abi.encodeWithSelector(ShareDebtToken.increaseReceiveAllowance.selector, owner, _addedValue)
        );
    ...
    function receiveAllowance(uint256 _addedValue, uint8 i, uint8 j, uint8 k) external setup {
        bool success;
        bytes memory returnData;
        ...
        (success, returnData) = actor.proxy(
            target,
            abi.encodeWithSelector(ShareDebtToken.receiveAllowance.selector, owner, recipient)
        );
