...
contract SiloConfigHandler is BaseHandler {
    ...
    function accrueInterestForSilo(uint8 i) external {
        ...
        assertGe(defaultVarsAfter[silo].debtAssets, defaultVarsBefore[silo].debtAssets, SILO_HSPOST_A);
        assertGe(defaultVarsAfter[silo].collateralAssets, defaultVarsBefore[silo].collateralAssets, SILO_HSPOST_A);
    }
