...
import {SiloIncentivesControllerGLCreateAndConfigure} from "silo-core/deploy/incentives-controller/SiloIncentivesControllerGLCreateAndConfigure.s.sol";
...
contract SiloDeployWithIncentives is SiloDeployWithDeployerOwner {
    function run() public override returns (ISiloConfig siloConfig) {
        ...
        SiloIncentivesControllerGLCreateAndConfigure createAndConfigure = new SiloIncentivesControllerGLCreateAndConfigure();
